...
export default class BlockEditorCanvasDrawer extends Vue {
  ...
  @Prop({default: 'rgb(32,32,32)'}) gridColorSmall : string;  
  @Prop({default: 'rgb(16,16,16)'}) gridColorBig : string;
  ...
  private drawGrid() {
    ...
    this.ctx.strokeStyle = this.gridColorSmall;
    ...
    for(let i = -gridOffx,
      ...
      if(count % 5 == 0) this.ctx.strokeStyle = this.gridColorBig;
      else if(this.viewScale < 70) continue;
      else this.ctx.strokeStyle = this.gridColorSmall;
